...
def get_args_parser():
    ...
    parser.add_argument("--dataset_file", type=str, default="CoOadTR/data/data_info_new.json")
    ...
    parser.add_argument(
        "--thumos_anno_path", type=str, default="CoOadTR/data/thumos_{}_anno.pickle"
    )
    ...
    parser.add_argument('--deepcot', action="store_true")
    # 'env://'
    return parser
