...
def _gaussian_scaled_dot_product_attention_step(
    ...
    attn_sm = gaussian_attention(q_sel, K_T_new)
...
class SingleOutputMultiheadAttention(MultiheadAttentionBase):
    ...
    def _forward_step(
        ...
        o, next_state = MultiheadAttentionBase._forward_step(
            self, query, key, value, prev_state, use_stride=self.use_stride,
        )
    ...
    def forward_steps(
        ...
        **kwargs,
        ...
        o = MultiheadAttentionBase.forward_steps(
            self, query, key, value, update_state, use_stride=self.use_stride, *args, **kwargs
        )
